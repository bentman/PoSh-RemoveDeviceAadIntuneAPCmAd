...
.EXAMPLE
    For cloud-only removal in AzureAD, Intune, and Autopilot.
        .\Remove-DeviceApIntuneAadCmAd.ps1 -serialNumber "XYZ1234" -AAD -Intune -Autopilot
    For on-prem removal in ConfigMgr and AD.
        .\Remove-DeviceApIntuneAadCmAd.ps1 -serialNumber "XYZ1234" -ConfigMgr -AD
    For removal across all platforms.
        .\Remove-DeviceApIntuneAadCmAd.ps1 -serialNumber "XYZ1234" -All
    For AD-only removal.
        .\Remove-DeviceApIntuneAadCmAd.ps1 -computerName "HQO-XYZ1234" -AD
.CREDIT
